...
background_conductivity = 1/background_res
overburden_conductivity = 1/overburden_res
slope_conductivity = 1/slope_res
...
cbar.set_label("Conductivity [Ohm.m]", rotation=270, labelpad=15, size=12)
