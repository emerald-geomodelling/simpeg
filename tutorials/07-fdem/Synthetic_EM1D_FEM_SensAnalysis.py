...
# model1:
res1=[1000, 100]  # resistivities mdoel1
z1=[10]           # layer depths model1

# model2:
res2=[1000, 100]  # resistivities mdoel2
z2=[20]          # layer depths model2
...
ax[1].text(0.6, 0.2, textstring, transform=ax[1].transAxes, fontsize=10,
...
thicknesses_for_plotting2 = np.r_[thicknesses2, 50.]
