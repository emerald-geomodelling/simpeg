...
def plot_layer(sig, mesh, xscale='log', ax=None, showlayers=False, xlim=None, plotSig=True, **kwargs):
    """
    ...
    if ax==None:
        ...
        if plotSig:
            plt.xlabel('Conductivities (S/m)', fontsize = 14)
        else:
        ...
        ax.set_xlim(sig_min*0.9, sig_max*1.1)
